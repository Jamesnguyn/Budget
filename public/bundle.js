...
let x = 21;
console.log(__WEBPACK_IMPORTED_MODULE_0__person__["c" /* isAdult */](x));
console.log(__WEBPACK_IMPORTED_MODULE_0__person__["a" /* canDrink */](x));
console.log(__WEBPACK_IMPORTED_MODULE_0__person__["b" /* default */](x));
